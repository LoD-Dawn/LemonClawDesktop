...
const translations: Record<LanguageType, Record<string, string>> = {
  zh: {
    ...
    coworkWorkingDirectoryHint: 'DiClaw 将在此目录下执行命令',
    coworkSystemPrompt: '系统提示词',
    coworkSystemPromptPlaceholder: '为 DiClaw 设置自定义指令...',
    coworkSystemPromptHint: '可选的系统提示词，用于自定义 DiClaw 的行为',
    coworkModelSettingsRequired: '请先在模型设置中配置可用模型与 API Key。',
    coworkModelSettingsTitle: '模型设置',
    coworkModelSettingsHint: 'DiClaw 使用模型设置中的当前模型与提供商配置。',
    ...
    coworkPermissionDescription: 'DiClaw 请求执行以下操作',
    coworkToolName: '工具名称',
  ...
  en: {
    ...
    coworkSettings: 'DiClaw Settings',
    ...
    coworkWorkingDirectoryHint: 'DiClaw will execute commands in this directory',
    coworkSystemPrompt: 'System Prompt',
    coworkSystemPromptPlaceholder: 'Set custom instructions for DiClaw...',
    coworkSystemPromptHint: 'Optional system prompt to customize DiClaw\'s behavior',
    ...
    coworkModelSettingsHint: 'DiClaw uses the current model and provider configuration from Model Settings.',
    ...
    coworkPermissionDescription: 'DiClaw is requesting to perform the following action',
