...
const translations: Record<LanguageType, Record<string, string>> = {
  zh: {
    ...
    searchScopeAll: '全部',
    searchScopeSessions: '任务记录',
    searchScopeScheduledTasks: '定时任务',
    searchKeyboardHint: 'Enter 打开 · ↑/↓ 切换 · Esc 关闭',
    searchPreviewTitle: '详情预览',
    searchPreviewEmpty: '请从左侧选择一个任务或记录',
    searchOpenAction: '打开',
    ...
    coworkHistory: '最近记录',
    coworkNoSessions: '还没有任务记录',
    coworkPinSession: '置顶任务',
    coworkUnpinSession: '取消置顶',
    coworkSessionActions: '更多操作',
    coworkPlaceholder: '今天想让我帮你做什么？',
    coworkWorkingDirectory: '工作目录',
    coworkWorkingDirectoryPlaceholder: '输入项目路径',
    coworkWorkingDirectoryEmpty: '不选也能开始',
    coworkWorkingDirectoryOptionalHint: '如果需要处理本地文件、项目或导出结果，再补充工作空间就可以。',
    coworkWorkingDirectoryHint: 'LemonClaw 将在此目录下执行命令',
    coworkSystemPrompt: '系统提示词',
    coworkSystemPromptPlaceholder: '为 LemonClaw 设置自定义指令...',
    coworkSystemPromptHint: '可选的系统提示词，用于自定义 LemonClaw 的行为',
    coworkModelSettingsRequired: '请先在模型设置中配置可用模型与 API Key。',
    coworkModelSettingsTitle: '模型设置',
    coworkModelSettingsHint: 'LemonClaw 使用模型设置中的当前模型与提供商配置。',
    ...
    coworkPermissionDescription: 'LemonClaw 请求执行以下操作',
    coworkToolName: '工具名称',
    ...
    coworkWelcome: '从一句话开始，也能慢慢做顺',
    coworkDescription: '一个安静、舒服的个人 AI 桌面助手，适合整理想法、处理任务和陪你完成日常工作。',
    coworkHeroEyebrow: 'LemonClaw for everyday life',
    coworkHeroTitle: '把想法、待办和灵感，慢慢变成结果',
    coworkHeroDescription: '不需要先学一堆功能，也不需要想清楚怎么提问。先把你现在在想的事说出来，LemonClaw 会陪你整理、推进，再一步步完成。',
    coworkHeroBenefitPersonal: '更像个人助手',
    coworkHeroBenefitGentle: '更柔和的使用节奏',
    coworkHeroBenefitReady: '一句话就能开始',
    coworkHeroCardStart: '开始方式',
    coworkHeroCardStartValue: '直接说一句你现在想做的事',
    coworkHeroCardSpace: '你的工作空间',
    coworkHeroCardSpaceEmpty: '还没选也没关系',
    coworkHeroCardAction: '你可以这样用',
    coworkHeroActionTagWrite: '写点内容',
    coworkHeroActionTagOrganize: '整理资料',
    coworkHeroActionTagCreate: '做个页面',
    coworkHeroPanelTitle: '先说你想做什么，剩下的交给 LemonClaw 一起推进',
    coworkHeroPanelDescription: '可以是一句问题、一段情绪化的描述，或者一件还没想清楚的小事。先开始，再慢慢补细节。',
    coworkQuickActionsTitle: '不知道怎么开口时，从这些日常场景开始',
    coworkQuickActionsDescription: '挑一个最接近你现在状态的入口，先获得一个顺手的起点。',
    coworkSidebarTagline: '陪你把事情慢慢做顺',
    coworkPrimarySectionTitle: '常用',
    coworkAdvancedSectionTitle: '进阶能力',
    coworkSidebarAutomation: '自动化',
    coworkSidebarSkills: '灵感模板',
    coworkSidebarConnections: '连接服务',
    coworkNoSessionsHint: '从一次提问或一个小任务开始，记录会自然留在这里。',
    loginScreenTitle: '登录后继续你的 LemonClaw',
    loginScreenDescription: '一个更安静、更舒服的个人 AI 桌面助手。',
    loginScreenHint: '点击上方按钮会在浏览器中打开登录页面，完成登录后会自动回到应用。',
    loginScreenBrowserHint: '登录会在浏览器中完成，这样更熟悉也更安全。',
    loginScreenOpenButton: '去登录',
    loginScreenOpening: '正在打开浏览器…',
    loginScreenOpenFailed: '暂时无法打开登录页，请检查网络后再试。',
    loginScreenErrorRetry: '登录遇到一点问题，请再试一次。',
    loginWaitingForBrowser: '等待浏览器完成登录…',
    coworkNewSession: '新任务',
    coworkContinuePlaceholder: '继续补充，或者直接说下一步想做什么...',
  ...
  en: {
    ...
    searchScopeAll: 'All',
    searchScopeSessions: 'Task Records',
    searchScopeScheduledTasks: 'Scheduled Tasks',
    searchKeyboardHint: 'Enter to open · Up/Down to navigate · Esc to close',
    searchPreviewTitle: 'Preview',
    searchPreviewEmpty: 'Select a record from the left panel',
    ...
    coworkHistory: 'Recent History',
    coworkNoSessions: 'No tasks yet',
    coworkPinSession: 'Pin task',
    coworkUnpinSession: 'Unpin task',
    coworkSessionActions: 'More actions',
    coworkPlaceholder: 'What would you like help with today?',
    coworkWorkingDirectory: 'Working Directory',
    coworkWorkingDirectoryPlaceholder: 'Enter project path',
    coworkWorkingDirectoryEmpty: 'Optional for getting started',
    coworkWorkingDirectoryOptionalHint: 'Add a workspace later if you want to work with local files, projects, or exports.',
    coworkWorkingDirectoryHint: 'LemonClaw will execute commands in this directory',
    coworkSystemPrompt: 'System Prompt',
    coworkSystemPromptPlaceholder: 'Set custom instructions for LemonClaw...',
    coworkSystemPromptHint: 'Optional system prompt to customize LemonClaw\'s behavior',
    ...
    coworkModelSettingsHint: 'LemonClaw uses the current model and provider configuration from Model Settings.',
    ...
    coworkSandboxBadge: 'Safe Mode',
    coworkLocalBadge: 'On Device',
    ...
    coworkPermissionDescription: 'LemonClaw is requesting to perform the following action',
    ...
    coworkWelcome: 'Start with one sentence and keep things moving',
    coworkDescription: 'A calm and comfortable personal AI desktop assistant for organizing thoughts, handling tasks, and supporting everyday work.',
    coworkHeroEyebrow: 'LemonClaw for everyday life',
    coworkHeroTitle: 'Turn thoughts, tasks, and sparks into steady progress',
    coworkHeroDescription: 'You do not need to learn a bunch of features first, and you do not need the perfect prompt. Just say what is on your mind and LemonClaw helps you sort it out, move it forward, and finish it step by step.',
    coworkHeroBenefitPersonal: 'Feels like a personal assistant',
    coworkHeroBenefitGentle: 'A gentler pace of use',
    coworkHeroBenefitReady: 'Start with one sentence',
    coworkHeroCardStart: 'How to begin',
    coworkHeroCardStartValue: 'Say the thing you want to get done',
    coworkHeroCardSpace: 'Your workspace',
    coworkHeroCardSpaceEmpty: 'You can start without one',
    coworkHeroCardAction: 'Good ways to use it',
    coworkHeroActionTagWrite: 'Write something',
    coworkHeroActionTagOrganize: 'Organize materials',
    coworkHeroActionTagCreate: 'Make a page',
    coworkHeroPanelTitle: 'Tell LemonClaw what you want to do, then let it help you move it along',
    coworkHeroPanelDescription: 'It can be a question, a rough thought, or a small task you have not fully figured out yet. Start first, fill in details later.',
    coworkQuickActionsTitle: 'If you are not sure how to start, begin with one of these everyday scenarios',
    coworkQuickActionsDescription: 'Pick the closest match to your current situation and get an easy first step.',
    coworkSidebarTagline: 'Helping things feel lighter and smoother',
    coworkPrimarySectionTitle: 'Everyday',
    coworkAdvancedSectionTitle: 'Advanced',
    coworkSidebarAutomation: 'Automation',
    coworkSidebarSkills: 'Templates',
    coworkSidebarConnections: 'Connections',
    coworkNoSessionsHint: 'Start with a question or a small task, and your history will grow here naturally.',
    loginScreenTitle: 'Sign in to continue with LemonClaw',
    loginScreenDescription: 'A calmer, more comfortable personal AI desktop assistant.',
    loginScreenHint: 'The button above opens the sign-in page in your browser and brings you back automatically after login.',
    loginScreenBrowserHint: 'Signing in through your browser feels more familiar and keeps the flow secure.',
    loginScreenOpenButton: 'Continue to sign in',
    loginScreenOpening: 'Opening your browser…',
    loginScreenOpenFailed: 'Unable to open the sign-in page right now. Please check your connection and try again.',
    loginScreenErrorRetry: 'Something went wrong while signing in. Please try again.',
    loginWaitingForBrowser: 'Waiting for your browser to finish signing in…',
    coworkNewSession: 'New Task',
    coworkContinuePlaceholder: 'Add a little more detail, or say what you want to do next...',
