...
const translations: Record<LanguageType, Record<string, string>> = {
  zh: {
    ...
    coworkQuotaExhaustedToast: '积分已用完，补充积分后再继续会话',
    coworkContinueFailedToast: '会话继续失败，请稍后重试',
  ...
  en: {
    ...
    coworkQuotaExhaustedToast: 'Credits are exhausted. Please top up before continuing.',
    coworkContinueFailedToast: 'Failed to continue the session. Please try again.',
