...
const translations: Record<LanguageType, Record<string, string>> = {
  zh: {
    ...
    coworkWelcome: '慢一点开始，也能更快完成',
    coworkDescription: '一个安静、舒服的个人 AI 桌面助手，适合整理想法、处理任务和陪你完成日常工作。',
    coworkHeroEyebrow: 'LemonClaw for everyday life',
    coworkHeroTitle: '把零碎想法，安静地变成结果',
    coworkHeroDescription: '面向 C 端用户设计的桌面 AI 工作台。减少压迫感和学习成本，让记录、提问、整理与执行都更自然。',
    coworkHeroBenefitPersonal: '更像个人助手',
    coworkHeroBenefitGentle: '更柔和的使用节奏',
    coworkHeroBenefitReady: '一句话就能开始',
    coworkHeroCardMode: '轻量协作',
    coworkHeroCardSpace: '你的工作空间',
    coworkHeroCardAction: '常用入口',
    coworkHeroPanelTitle: '从一个问题、一段想法或一个任务开始',
    coworkHeroPanelDescription: 'LemonClaw 会帮你梳理、执行并持续推进，保持安静但不失效率。',
    coworkQuickActionsTitle: '试试这些轻量入口',
    coworkQuickActionsDescription: '给你一个更容易开始的第一步，而不是一块复杂面板。',
    coworkSidebarTagline: '安静、舒服的桌面 AI 助手',
    coworkNoSessionsHint: '从一次提问或一个小任务开始，记录会自然留在这里。',
    loginScreenTitle: '登录后继续你的 LemonClaw',
    loginScreenDescription: '一个更安静、更舒服的个人桌面 AI 助手。',
  ...
  en: {
    ...
    coworkWelcome: 'Start softly, still move fast',
    ...
    coworkHeroEyebrow: 'LemonClaw for everyday life',
    coworkHeroTitle: 'Turn scattered thoughts into calm progress',
    coworkHeroDescription: 'A desktop AI workspace designed for consumers. Lower pressure, lower friction, and a gentler way to ask, organize, and get things done.',
    ...
    coworkHeroCardMode: 'Light collaboration',
    coworkHeroCardSpace: 'Your workspace',
    coworkHeroCardAction: 'Common entry points',
    coworkHeroPanelTitle: 'Begin with one question, one idea, or one task',
    coworkHeroPanelDescription: 'LemonClaw helps you organize, execute, and keep momentum without making the interface feel loud.',
    coworkQuickActionsTitle: 'Try these lighter entry points',
    coworkQuickActionsDescription: 'A simpler first step instead of a crowded control panel.',
    coworkSidebarTagline: 'A calm and comfortable desktop AI assistant',
    ...
    loginScreenDescription: 'A calmer, more comfortable personal desktop AI assistant.',
