...
const IMSettings: React.FC = () => {
  ...
  return (
    <div className="flex h-full gap-4">
      ...
      <div className="w-48 flex-shrink-0 border-r dark:border-dark-border border-border pr-3 space-y-2 overflow-y-auto">
      ...
      <div className="flex-1 min-w-0 pl-4 pr-2 space-y-4 overflow-y-auto [scrollbar-gutter:stable]">
        {/* Header with status */}
        <div className="flex items-center gap-3 pb-3 border-b dark:border-dark-border/60 border-border/60">
          <div className="flex items-center gap-2">
            <div className="flex h-7 w-7 items-center justify-center rounded-md bg-white dark:bg-dark-border/30 p-1">
              <img
        ...
        {activePlatform === 'dingtalk' && (
          <div className="space-y-3">
            ...
            <div className="space-y-1.5">
              <label className="block text-xs font-medium dark:text-dark-text-secondary text-text-secondary">
                Client ID (AppKey)
              </label>
              <div className="relative">
                <input
                  ...
                  className="block w-full rounded-lg dark:bg-dark-surface/80 bg-surface/80 dark:border-dark-border/60 border-border/60 border focus:border-primary focus:ring-1 focus:ring-primary/30 dark:text-dark-text text-text-primary px-3 py-2 pr-8 text-sm transition-colors"
            ...
            <div className="space-y-1.5">
              ...
              <div className="relative">
                <input
                  ...
                  onBlur={handleSaveConfig}
                  className="block w-full rounded-lg dark:bg-dark-surface/80 bg-surface/80 dark:border-dark-border/60 border-border/60 border focus:border-primary focus:ring-1 focus:ring-primary/30 dark:text-dark-text text-text-primary px-3 py-2 pr-16 text-sm transition-colors"
                  placeholder="••••••••••••"
                />
            ...
            <div className="space-y-1.5">
              ...
              <div className="flex gap-2">
                <input
                  ...
                  className="block flex-1 rounded-lg dark:bg-dark-surface/80 bg-surface/80 dark:border-dark-border/60 border-border/60 border focus:border-primary focus:ring-1 focus:ring-primary/30 dark:text-dark-text text-text-primary px-3 py-2 text-sm transition-colors"
              ...
              {(config.telegram.allowedUserIds || []).length > 0 && (
                <div className="flex flex-wrap gap-1.5 mt-1.5">
                  {(config.telegram.allowedUserIds || []).map((id) => (
                    <span
                      key={id}
                      className="inline-flex items-center gap-1 px-2 py-0.5 rounded-md text-xs dark:bg-dark-surface/80 bg-surface/80 dark:border-dark-border/60 border-border/60 border dark:text-dark-text text-text-primary"
                    >
                      {id}
                      <button
                        type="button"
                        ...
                        className="text-text-secondary dark:text-dark-text-secondary hover:text-red-500 dark:hover:text-red-400 transition-colors"
                      >
          ...
          <div className="space-y-3">
            ...
            <div className="space-y-1.5">
              ...
              <select
                ...
                className="block w-full rounded-lg dark:bg-dark-surface/80 bg-surface/80 dark:border-dark-border/60 border-border/60 border focus:border-primary focus:ring-1 focus:ring-primary/30 dark:text-dark-text text-text-primary px-3 py-2 text-sm transition-colors"
              >
        ...
        {connectivityModalPlatform && (
          ...
          >
            <div
              className="w-full max-w-2xl dark:bg-dark-surface bg-surface rounded-2xl shadow-modal border dark:border-dark-border border-border overflow-hidden"
              onClick={(e) => e.stopPropagation()}
            >
              <div className="px-4 py-3 border-b dark:border-dark-border border-border flex items-center justify-between">
                <div className="text-sm font-semibold dark:text-dark-text text-text-primary">
                ...
                <button
                  ...
                  onClick={() => setConnectivityModalPlatform(null)}
                  className="p-1 rounded-md dark:hover:bg-dark-surface-hover hover:bg-surface-hover dark:text-dark-text-secondary text-text-secondary"
                >
              ...
              <div className="p-4 max-h-[65vh] overflow-y-auto">
                {testingPlatform === connectivityModalPlatform ? (
                  <div className="text-sm dark:text-dark-text-secondary text-text-secondary">
                    {i18nService.t('imConnectivityTesting')}
                  </div>
                    ...
                    <div className="space-y-2">
                      {connectivityResults[connectivityModalPlatform]!.checks.map((check, index) => (
                        <div
                          ...
                          className="rounded-lg border dark:border-dark-border/60 border-border/60 px-2.5 py-2 dark:bg-dark-surface/25 bg-white/70"
                        >
                          ...
                          {getCheckSuggestion(check) && (
                            <div className="mt-1 text-[11px] dark:text-dark-text-secondary text-text-secondary">
              ...
              <div className="px-4 py-3 border-t dark:border-dark-border border-border flex items-center justify-end">
