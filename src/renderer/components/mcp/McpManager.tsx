      ...
      {activeTab === 'installed' && (
        <div className="grid grid-cols-2 gap-3">
          {filteredInstalled.length === 0 ? (
            <div className="col-span-2 text-center py-12 text-sm dark:text-dark-text-secondary text-text-secondary">
            ...
            filteredInstalled.map((server) => {
              ...
              return (
                <div
                  key={server.id}
                  className="rounded-xl border dark:border-dark-border border-border dark:bg-dark-surface/50 bg-surface/50 p-3 transition-colors hover:border-primary/50"
                >
                  <div className="flex items-start justify-between mb-2">
                    <div className="flex items-center gap-2 min-w-0">
                      <div className="w-7 h-7 rounded-lg dark:bg-dark-surface bg-surface flex items-center justify-center flex-shrink-0">
                        <ConnectorIcon className="h-4 w-4 dark:text-dark-text-secondary text-text-secondary" />
                      </div>
                    ...
                    <div className="flex items-center gap-1.5 flex-shrink-0">
                      <button
                        ...
                        className="p-1 rounded-lg text-text-secondary dark:text-dark-text-secondary hover:text-primary dark:hover:text-primary transition-colors"
                      ...
                      <div
                        className={`w-9 h-5 rounded-full flex items-center transition-colors cursor-pointer flex-shrink-0 ${
                          server.enabled ? 'bg-primary' : 'dark:bg-dark-border bg-border'
                        }`}
        ...
        <div className="space-y-6">
          ...
          <div className="grid grid-cols-2 gap-3">
            ...
            <button
              ...
              className="rounded-xl border-2 border-dashed dark:border-dark-border border-border dark:text-dark-text-secondary text-text-secondary hover:border-primary hover:text-primary dark:hover:border-primary dark:hover:text-primary transition-colors flex items-center justify-center min-h-[120px] text-sm"
            >
