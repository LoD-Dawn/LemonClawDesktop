...
export type TaskOrigin =
  | { kind: OriginKind; platform: string; conversationId: string }
  | { kind: OriginKind; sessionId: string }
  | { kind: OriginKind };

export type ExecutionBinding =
  | { kind: BindingKind }
  | { kind: BindingKind; sessionId: string }
  | { kind: BindingKind; platform: string; conversationId: string; sessionId?: string }
  | { kind: BindingKind; sessionKey: string };
