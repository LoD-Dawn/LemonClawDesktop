// vendor/openclaw-runtime/win-x64/extensions/thread-ownership/index.ts
var mentionedThreads = /* @__PURE__ */ new Map();
var MENTION_TTL_MS = 5 * 60 * 1e3;
...
function resolveOwnershipAgent(config) {
  const list = Array.isArray(config.agents?.list) ? config.agents.list.filter(
