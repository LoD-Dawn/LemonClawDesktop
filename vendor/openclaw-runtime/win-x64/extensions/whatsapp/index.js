// vendor/openclaw-runtime/win-x64/extensions/whatsapp/index.ts
import { emptyPluginConfigSchema } from "openclaw/plugin-sdk";

// vendor/openclaw-runtime/win-x64/extensions/whatsapp/src/channel.ts
import {
...
// vendor/openclaw-runtime/win-x64/extensions/whatsapp/src/runtime.ts
var runtime = null;
...
// vendor/openclaw-runtime/win-x64/extensions/whatsapp/src/channel.ts
var meta = getChatChannelMeta("whatsapp");
var whatsappPlugin = {
  id: "whatsapp",
  meta: {
    ...meta,
  ...
  security: {
    resolveDmPolicy: ({ cfg, accountId, account }) => {
      ...
      const basePath = useAccountPath ? `channels.whatsapp.accounts.${resolvedAccountId}.` : "channels.whatsapp.";
      return {
  ...
  outbound: {
    ...
    sendPoll: async ({ to, poll, accountId }) => await getWhatsAppRuntime().channel.whatsapp.sendPollWhatsApp(to, poll, {
      verbose: getWhatsAppRuntime().logging.shouldLogVerbose(),
      accountId: accountId ?? void 0
    })
  },
  auth: {
    login: async ({ cfg, accountId, runtime: runtime2, verbose }) => {
  ...
  status: {
    ...
    buildAccountSnapshot: async ({ account, runtime: runtime2 }) => {
      ...
      return {
        ...
        lastMessageAt: runtime2?.lastMessageAt ?? null,
    ...
    logSelfId: ({ account, runtime: runtime2, includeChannelPrefix }) => {
  ...
  gateway: {
    ...
    logoutAccount: async ({ account, runtime: runtime2 }) => {
