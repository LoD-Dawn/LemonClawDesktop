// vendor/openclaw-runtime/win-x64/extensions/slack/index.ts
import { emptyPluginConfigSchema } from "openclaw/plugin-sdk";

// vendor/openclaw-runtime/win-x64/extensions/slack/src/channel.ts
import {
...
// vendor/openclaw-runtime/win-x64/extensions/slack/src/runtime.ts
var runtime = null;
...
// vendor/openclaw-runtime/win-x64/extensions/slack/src/channel.ts
var meta = getChatChannelMeta("slack");
...
var slackPlugin = {
  ...
  config: {
    ...
    resolveDefaultTo: ({ cfg, accountId }) => resolveSlackAccount({ cfg, accountId }).config.defaultTo?.trim() || void 0
  },
  security: {
    resolveDmPolicy: ({ cfg, accountId, account }) => {
      const resolvedAccountId = accountId ?? account.accountId ?? DEFAULT_ACCOUNT_ID;
      const useAccountPath = Boolean(cfg.channels?.slack?.accounts?.[resolvedAccountId]);
      const allowFromPath = useAccountPath ? `channels.slack.accounts.${resolvedAccountId}.dm.` : "channels.slack.dm.";
      return {
